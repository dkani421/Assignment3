...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        ...
        <p>The application stores image information in a database or text file and provides seamless navigation through a variety of high-quality pictures. Whether in sequential or random mode, the slideshow offers an engaging visual journey with more than 20 captivating images.</p>
    </main>
</asp:Content>
